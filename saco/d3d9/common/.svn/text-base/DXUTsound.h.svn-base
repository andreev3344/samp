...
public:
    ...
    HRESULT Create( CSound** ppSound, PCHAR strWaveFileName, DWORD dwCreationFlags = 0, GUID guid3DAlgorithm = GUID_NULL, DWORD dwNumBuffers = 1 );
    ...
    HRESULT CreateStreaming( CStreamingSound** ppStreamingSound, PCHAR strWaveFileName, DWORD dwCreationFlags, GUID guid3DAlgorithm, DWORD dwNotifyCount, DWORD dwNotifySize, HANDLE hNotifyEvent );
};
...
public:
    ...
    HRESULT Open( PCHAR strFileName, WAVEFORMATEX* pwfx, DWORD dwFlags );
