...
{
public:
	static unsigned int HashString(char* szString) 
	{
	...
	#	define mix(a,b,c) \
		...
		register unsigned char* k = (unsigned char*)szString;
		register unsigned int initval = 0x12345678;
		register unsigned int length;

		length = (unsigned int)strlen(szString);
